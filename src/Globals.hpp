...
namespace Network
{
    ...
    constexpr const char*   RASPBERRY_PI_SERVER_IP{"192.168.0.165"};    //direct IP so we don't have to resolve by DNS
...
namespace Sensing
{
    ...
    constexpr const long    SENSING_THRESHOLD_IN_CM{25};                            //threshold for the sensor to be considered on
